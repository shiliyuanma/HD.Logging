...
using HD.Logging.Abstractions.Internal;
...
namespace HD.Logging.Abstractions
{
    ...
    public static class LoggerExtensions
    {
        ...
        public static void LogDebug(this ILogger logger, Exception exception)
        {
            ...
            logger.Log(LogLevel.Debug, 0, null, exception, _messageFormatter);
        }
        #endregion
        ...
        public static void LogTrace(this ILogger logger, Exception exception)
        {
            ...
            logger.Log(LogLevel.Trace, 0, null, exception, _messageFormatter);
        }
        #endregion
        ...
        public static void LogInformation(this ILogger logger, Exception exception)
        {
            ...
            logger.Log(LogLevel.Information, 0, null, exception, _messageFormatter);
        }
        #endregion
        ...
        public static void LogWarning(this ILogger logger, Exception exception)
        {
            ...
            logger.Log(LogLevel.Warning, 0, null, exception, _messageFormatter);
        }
        #endregion
        ...
        private static string MessageFormatter(object state, Exception ex)
        {
            return state?.ToString() ?? ex?.ToString();
        }
        #endregion
    }
}